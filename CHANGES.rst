...
-   Fixed :class:`~wtforms.fields.core.SelectMultipleField` validation
    when using choices list shortcut. :issue:`612` :pr:`661`
-   Fixed usage of :class:`~wtforms.fields.core.MultipleFileField` with the
    :class:`~wtforms.validators.Regexp` validator. :issue:`442` :pr:`663`
