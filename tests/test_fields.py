...
class IntegerFieldTest(TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(
            form.b(), """<input id="b" name="b" type="text" value="-15">"""
        )
...
class TimeFieldTest(TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(form.a.data, d)
        self.assertEqual(
            form.a(), """<input id="a" name="a" type="text" value="4:30">"""
        )
        self.assertEqual(form.b.data, d)
        self.assertEqual(
            form.b(), """<input id="b" name="b" type="text" value="04:30">"""
        )
        self.assertTrue(form.validate())
...
class DateTimeFieldTest(TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            form.a(),
            """<input id="a" name="a" type="text" value="2008-05-05 04:30:00">""",
        )
        self.assertEqual(form.b.data, d)
        self.assertEqual(
            form.b(), """<input id="b" name="b" type="text" value="2008-05-05 04:30">"""
        )
        self.assertTrue(form.validate())
